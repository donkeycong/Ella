...
setwd("04.GO")        #Setting up a working directory
rt=read.table("interGene.txt", header=F, sep="\t", check.names=F)     #Reading input files
...
#Define the number of GOs to be displayed
showNum=10
if(nrow(GO)<30){
  showNum=nrow(GO)
}
...
#Bar chart
pdf(file="barplot.pdf", width=15, height=22)
...
#Air bubble chart
pdf(file="bubble.pdf", width=15, height=22)
...
#Drawing the main part of the circle diagram
...
circos.clear()
#Drawing the legend in the middle of the circle diagram
...
#Legend for drawing the GO classification
main.legend = Legend(
