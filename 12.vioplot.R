...
library(vioplot)                      #Citation package 
inputFile="CIBERSORT-Results.txt"     #Input files
setwd("12.vioplot")     #Setting up a working directory

#Read the immune cell infiltration file
...
#For each immune cell cycle, the vioplot is plotted, with the control group shown in blue and the experimental group shown in red
for(i in 1:ncol(rt)){
...
#Export of immune cells and p-value table files
